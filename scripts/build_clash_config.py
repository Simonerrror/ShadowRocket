...
SHADOWROCKET_AUTO_SUBSCRIPTION_FILTER = r"(?i)^(?!.*(?:Russia|Belarus|Ukraine))(?!.*\bWL\b).*\b(?:VLESS|TT|Naive|NV|MR|AWG2)\b.*$"
...
MIHOMO_AUTO_SUBSCRIPTION_FILTER = r"(?i)\b(?:VLESS|TT|Naive|NV|MR|AWG2)\b"
