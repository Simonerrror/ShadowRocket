...
- Generated, не редактировать вручную: `clash_config.yaml`, `XKeen/05_routing.json`, `HAPP/DEFAULT.*`, `distillate/text/**`, `distillate/dat/**`, `distillate/summary.json`, `rules/google-all.list`, `rules/microsoft.list`, `rules/domains_community.list`, `rules/telegram.list`, `rules/whitelist_direct.list`, `rules/greylist_proxy.list`, `rules/anti_advertising*.list`.
...
## Каскад пересборки
- Изменили `shadowrocket.conf`: пересоберите `clash_config.yaml`, `XKeen/05_routing.json`, `HAPP/DEFAULT.*`.
- Изменили `distillate/manifest.json`, `distillate/overlays/*`, `distillate/filters/*` или vendored upstream в `distillate/upstream/*`: пересоберите `distillate/text/*`, `distillate/dat/*`, `distillate/summary.json`, generated `rules/*.list`, anti-ad module refs, `XKeen/05_routing.json`, `HAPP/DEFAULT.*`.
